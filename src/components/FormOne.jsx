        ...
        <div className='formOne'>
            <form onSubmit={handleSubmit}>
                ...
                <div className='section_1'>
                    <label>Name: <input type="text" name="name" value={formData.name} onChange={handleChange} autoComplete="off" required /></label>
                    <label>Age: <input type="text" name="age" value={formData.age} onChange={handleChange} autoComplete="off" required /></label>
                    <label>
                        Area:
                    ...
                    <label>Location: <input type="text" name="location" value={formData.location} onChange={handleChange} autoComplete="off" required /></label>
                    <label>
                        Education:
                    ...
                    <label>Weight: <input type="text" name="weight" value={formData.weight} onChange={handleChange} autoComplete="off" required /></label>
                    <label>Height: <input type="text" name="height" value={formData.height} onChange={handleChange} autoComplete="off" required /></label>
                </div>
                ...
                <div className='section_2'>
                    ...
                    <label>Complication Remarks: <input type="text" name="complicationRemarks" value={formData.complicationRemarks} onChange={handleChange} autoComplete="off" required /></label>
                    <label>
                        Gravida:
                    ...
                    <label>Mensural Date: <input type="date" name="mensuralDate" value={formData.mensuralDate} onChange={handleDateChange} autoComplete="off" required /></label>
                    <label>Expected Delivery Date: <input type="date" name="expectedDeliveryDate" value={formData.expectedDeliveryDate} onChange={handleDateChange} autoComplete="off" required /></label>
                    <label>Gestational Age: <input type="text" name="gestationalAge" value={formData.gestationalAge} onChange={handleChange} autoComplete="off" required /></label>
                    <label>Systolic BP: <input type="text" name="systolicBP" value={formData.systolicBP} onChange={handleChange} autoComplete="off" required /></label>
                    <label>Diastolic BP: <input type="text" name="diastolicBP" value={formData.diastolicBP} onChange={handleChange} autoComplete="off" required /></label>
                    <label>Haemoglobin: <input type="text" name="haemoglobin" value={formData.haemoglobin} onChange={handleChange} autoComplete="off" required /></label>
